...
import { AccessContext, UserRole } from '../types/common';
...
export class CommonController {
  ...
  private createAccessContext(req: AuthenticatedRequest): AccessContext {
    return {
  ...
  // Task operations
  async getProjectTasks(req: AuthenticatedRequest, res: Response): Promise<void> {
    try {
  ...
  async getUserProjectTasks(req: AuthenticatedRequest, res: Response): Promise<void> {
    try {
